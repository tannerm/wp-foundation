...
class WPFOUNDATION_walker extends Walker_Nav_Menu {
...
class WPFOUNDATION_Excerpt {
	...
	public static function length($new_length = 55) {
		WPFOUNDATION_Excerpt::$length = $new_length;

		add_filter('excerpt_length', 'WPFOUNDATION_Excerpt::new_length');

		WPFOUNDATION_Excerpt::output();
	}

	// Tells WP the new length
	public static function new_length() {
		if( isset(WPFOUNDATION_Excerpt::$types[WPFOUNDATION_Excerpt::$length]) )
			return WPFOUNDATION_Excerpt::$types[WPFOUNDATION_Excerpt::$length];
		else
			return WPFOUNDATION_Excerpt::$length;
	}
...
function wpfoundation_excerpt($length = 55) {
	WPFOUNDATION_Excerpt::length($length);
}

function wpfoundation_wp_trim_excerpt($text) {
	$raw_excerpt = $text;
	if ( '' == $text ) {
