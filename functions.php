<?php
/**
 * WP Foudnation functions and definitions
 *
 ...
 *
 * @package WP Foudnation
 * @since 0.1.0
 */

// Useful global constants
define( 'WPFOUNDATION_VERSION', '0.1.0' );


WPFOUNDATION_Setup::get_instance();
class WPFOUNDATION_Setup {
	...
	/**
	 * Only make one instance of the WPFOUNDATION_Setup
	 *
	 * @return WPFOUNDATION_Setup
	 */
	public static function get_instance() {
		if ( ! self::$_instance instanceof WPFOUNDATION_Setup ) {
	...
	protected function enqueue_styles() {
		...
		wp_enqueue_style( 'wpfoundation', get_template_directory_uri() . "/assets/css/wp_foudnation_theme{$postfix}.css", array(), WPFOUNDATION_VERSION );
	}
	...
	protected function enqueue_scripts() {
		...
		wp_enqueue_script('myapp', get_template_directory_uri(). '/js/wpfoundation.js', array(), '01', true);
		if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
			wp_enqueue_script( 'comment-reply' );
		}

		if ( is_singular() && wp_attachment_is_image() ) {
			wp_enqueue_script( 'wpfoundation-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
		}

		wp_enqueue_script( 'wpfoundation', get_template_directory_uri() . "/assets/js/wp_foudnation_theme{$postfix}.js", array( 'jquery', 'foundation' ), WPFOUNDATION_VERSION, true );
	}
